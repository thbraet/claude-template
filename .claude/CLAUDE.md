...
| 4. Modeling | In Progress | [4.1](docs/crisp-dm/4-modeling/4.1-modeling-techniques.md), [4.2](docs/crisp-dm/4-modeling/4.2-test-design.md), [4.3](docs/crisp-dm/4-modeling/4.3-model-building.md); Notebooks: [4.1](notebooks/4.1-modeling-techniques.ipynb), [4.2](notebooks/4.2-test-design.ipynb), [4.3](notebooks/4.3-model-building.ipynb) |
