...
| 3. Data Preparation | In Progress | [3.1](docs/crisp-dm/3-data-preparation/3.1-select-data.md), [3.2](docs/crisp-dm/3-data-preparation/3.2-clean-data.md), [3.3](docs/crisp-dm/3-data-preparation/3.3-construct-data.md); Notebooks: [3.1](notebooks/3.1-select-data.ipynb), [3.2](notebooks/3.2-clean-data.ipynb), [3.3](notebooks/3.3-construct-data.ipynb) |
